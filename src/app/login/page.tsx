...
export default async function LoginPage() {
        ...
        <div className="flex h-screen w-full relative overflow-hidden bg-background items-center justify-center p-4">
          ...
          <div className="w-full max-w-lg space-y-6 glass-panel p-8 rounded-2xl border border-red-500/30">
            ...
            <div className="mt-8 flex justify-center">
              <a href="/login" className="px-6 py-2 bg-white/5 border border-white/10 rounded hover:bg-white/10 text-sm font-medium text-white transition-colors">
                Retry Connection
              </a>
            </div>
          </div>
  ...
  console.log("LOGIN PAGE - User count is:", userCount)
  if (userCount === 0) {
    redirect("/setup")
  }
