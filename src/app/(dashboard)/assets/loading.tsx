import { Server, Filter, ChevronLeft, ChevronRight, Search } from "lucide-react"
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6 animate-fade-in-up">
      ...
      <div className="glass-card rounded-xl p-4 flex gap-4 items-center mb-6 border border-border">
        ...
        <div className="flex flex-1 gap-4 items-end flex-wrap">
          ...
          <div className="h-9 w-[120px] bg-cyan-500/10 rounded-md animate-pulse" />
        </div>
      </div>
        ...
        <Table className="table-fixed">
          <TableHeader className="bg-black/20">
            <TableRow className="border-border">
              <TableHead className="font-semibold text-primary/50 pl-6 w-[15%]">Asset Key</TableHead>
              <TableHead className="font-semibold text-primary/50 w-[35%]">Name</TableHead>
              <TableHead className="font-semibold text-primary/50 w-[10%]">Type</TableHead>
              <TableHead className="font-semibold text-primary/50 w-[15%]">IP Address</TableHead>
              <TableHead className="font-semibold text-primary/50 w-[10%]">Status</TableHead>
              <TableHead className="font-semibold text-primary/50 text-right pr-6 w-[15%]">Cataloged On</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {Array.from({ length: 10 }).map((_, i) => (
              <TableRow key={i} className="border-border/50">
                ...
                <TableCell className="py-4">
                  <div className="h-5 w-3/4 max-w-[250px] bg-white/10 rounded animate-pulse"></div>
                </TableCell>
                <TableCell className="py-4">
