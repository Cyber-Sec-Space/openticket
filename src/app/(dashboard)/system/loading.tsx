            ...
            <div className="grid gap-6">
              ...
              <div className="flex flex-row items-center space-x-4 rounded-md border border-white/10 p-5 shadow-sm bg-black/20">
                ...
                <div className="space-y-1 w-full">
                  <div className="h-[14px] w-56 flex items-center bg-white/10 rounded animate-pulse"></div>
                  <div className="flex flex-col gap-1 w-3/4 pt-1">
              ...
              <div className="flex flex-row items-center space-x-4 rounded-md border border-white/10 p-5 shadow-sm bg-black/20">
                <div className="h-4 w-4 shrink-0 bg-white/10 rounded-[4px] animate-pulse border border-input"></div>
                <div className="space-y-1 w-full">
                  <div className="h-[14px] w-72 flex items-center bg-white/10 rounded animate-pulse"></div>
                  <div className="flex flex-col gap-1 w-3/4 pt-1">
                    <div className="h-[12px] w-full bg-white/5 rounded animate-pulse"></div>
              ...
              <div className="flex flex-row items-center space-x-4 rounded-md border border-white/10 p-5 shadow-sm bg-black/20">
                <div className="h-4 w-4 shrink-0 bg-white/10 rounded-[4px] animate-pulse border border-input"></div>
                <div className="space-y-1 w-full">
                  <div className="h-[14px] w-60 flex items-center bg-white/10 rounded animate-pulse"></div>
                  <div className="flex flex-col gap-1 w-3/4 pt-1">
                    <div className="h-[12px] w-full bg-white/5 rounded animate-pulse"></div>
