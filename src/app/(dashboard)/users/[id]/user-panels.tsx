...
export function UserPanels({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
      ...
      {/* Audit Log Panel */}
      <Dialog>
        <DialogTrigger render={<button className="w-full text-left outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-2xl" />}>
        ...
        <DialogContent className="w-[95vw] sm:max-w-[90vw] md:max-w-5xl h-[85vh] bg-black/95 border border-emerald-500/30 shadow-[0_0_50px_rgba(16,185,129,0.1)] flex flex-col overflow-hidden p-6">
          <DialogHeader>
      ...
      {/* Evidence Format */}
      <Dialog>
        <DialogTrigger render={<button className="w-full text-left outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-2xl" />}>
        ...
        <DialogContent className="w-[95vw] sm:max-w-[90vw] md:max-w-5xl h-[85vh] bg-black/95 border border-blue-500/30 shadow-[0_0_50px_rgba(59,130,246,0.1)] flex flex-col overflow-hidden p-6">
          <DialogHeader>
      ...
      <Dialog>
        ...
        <DialogContent className="w-[95vw] sm:max-w-[90vw] md:max-w-6xl h-[85vh] bg-black/95 border border-orange-500/30 shadow-[0_0_50px_rgba(249,115,22,0.1)] flex flex-col overflow-hidden p-6">
          <DialogHeader>
