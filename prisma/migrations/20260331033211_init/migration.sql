-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'SECOPS', 'REPORTER');

-- CreateEnum
CREATE TYPE "AssetType" AS ENUM ('SERVER', 'ENDPOINT', 'NETWORK', 'SOFTWARE', 'OTHER');

-- CreateEnum
CREATE TYPE "AssetStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'COMPROMISED', 'MAINTENANCE');

-- CreateEnum
CREATE TYPE "Severity" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'CRITICAL');

-- CreateEnum
CREATE TYPE "IncidentStatus" AS ENUM ('NEW', 'IN_PROGRESS', 'PENDING_INFO', 'RESOLVED', 'CLOSED');
